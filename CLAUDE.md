...
├── controls.json               # 223 compliance controls specification
...
6. **Control Engine**: 223 base controls, `compliance_floor` controls cannot be disabled
...
- **223 controls** across 14 categories (BSA/AML, CDD, Fair Lending, Collections, Cybersecurity, etc.)
...
| Compliance controls (223) | Defined |
